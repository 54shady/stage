...
struct QEMU_PACKED usb_udisk_csw {
    uint32_t sig;
    uint32_t tag;
    uint32_t residue;
    uint8_t status;
...
#define TYPE_USB_UDISK "usb-udisk"
DECLARE_INSTANCE_CHECKER(MSDState, USB_UDISK_DEV,
                         TYPE_USB_UDISK)
